    ...
    private void processAnnotation(Class<?> clazz, Object instance) throws InvalidConfigurationException, IllegalAccessException {
        ...
        for (Field field : fields) {
            if (field.isAnnotationPresent(Auto.class)) {
                ...
                for (Object obj : objectsByClassName.values()) {
                ...
                if (auto.isRequired() && candidate == null) {
                ...
                if (candidate != null) {
                    ...
                    System.out.println("[@Auto] Поле \"" + field.getName() + "\" в " + clazz.getSimpleName() + " инициализировано объектом типа " + candidate.getClass().getSimpleName());
                } else {
                    System.out.println("[@Auto] ВНИМАНИЕ: не найден подходящий бин для поля \"" + field.getName() + "\" в " + clazz.getSimpleName());
                }
            }
        }
    }
